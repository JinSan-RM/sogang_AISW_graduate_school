...
- Legacy Swing2App board import script exists for `board_articles(구분).xlsx` and `정보통신대학원 어플 작성글.csv`; on 2026-06-21 the local Docker PostgreSQL import created 821 posts, 654 attachments, and 356 comments.
