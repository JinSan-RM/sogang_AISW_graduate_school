...
- Completed QA 173 bottom-tab reentry alignment: pressing an inactive Notices, Community, or Participation bottom tab recreates the corresponding root at `전체`, `행사 사진첩`, or `동아리 > 안내` and scrolls it to the top; active-tab represses, detail Back, My Page returns, Home, and Council remain state-preserving.
