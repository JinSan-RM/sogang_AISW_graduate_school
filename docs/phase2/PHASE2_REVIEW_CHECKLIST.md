...
- [x] Current Alembic head is `0022`; clean upgrade and the isolated `0021`→`0022`→`0021`→`0022` rehearsal passed. Earlier `0019` and exact-legacy recovery checks remain valid.
