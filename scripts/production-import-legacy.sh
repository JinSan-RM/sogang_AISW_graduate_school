...
[[ "$created_attachments" == 644 ]] || fail "Expected 644 imported attachments; found $created_attachments."
[[ "$archived_unsupported" == 4 ]] || fail "Expected 4 archived unsupported attachments; found $archived_unsupported."
[[ "$verified_files" == 644 ]] || fail "Expected 644 verified media files; found $verified_files."
[[ "$verified_bytes" == 710833138 ]] || fail "Verified media byte count changed: $verified_bytes."
